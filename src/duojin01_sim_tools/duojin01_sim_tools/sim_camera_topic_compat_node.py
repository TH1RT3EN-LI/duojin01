...
class SimCameraTopicCompatNode(Node):
    """
    @author litianshun (litianshun.cn@gmail.com)
    @date 2026-02-10
    从Gazebo桥接仿真深度相机话题到 ROS
    """

    def __init__(self):
        super().__init__("sim_camera_topic_compat_node")
        ...
        self.get_logger().info(
            "sim_camera_topic_compat_node started: "
