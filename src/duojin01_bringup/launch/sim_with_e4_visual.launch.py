...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "gz_partition",
                default_value=EnvironmentVariable("DUOJIN01_GZ_PARTITION", default_value=f"duojin01_e4_visual_{os.getpid()}"),
            ),
            ...
            DeclareLaunchArgument(
                "arm_variant",
                default_value=EnvironmentVariable("DUOJIN01_ARM_VARIANT", default_value="e4_visual"),
            ),
            DeclareLaunchArgument(
                "arm_mount_xyz",
            ...
            DeclareLaunchArgument(
                "e4_part4_xyz",
                default_value=EnvironmentVariable("DUOJIN01_E4_PART4_XYZ", default_value="0.155 0.16 0"),
            ),
            DeclareLaunchArgument(
                "e4_part4_rpy",
                default_value=EnvironmentVariable("DUOJIN01_E4_PART4_RPY", default_value="1.5708 0 -4.015"),
            ),
            ...
            SetEnvironmentVariable("DUOJIN01_E4_PART4_XYZ", LaunchConfiguration("e4_part4_xyz")),
            SetEnvironmentVariable("DUOJIN01_E4_PART4_RPY", LaunchConfiguration("e4_part4_rpy")),
